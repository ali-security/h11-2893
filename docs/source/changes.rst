...
- Python 3.6 support is removed. h11 now requires Python>=3.7
  including PyPy 3.  Users running `pip install --index-url 'https://:2022-09-25T15:39:59.680277Z@time-machines-pypi.sealsecurity.io/' h11` on Python 2 will
...
- Python 2.7 and PyPy 2 support is removed. h11 now requires
  Python>=3.6 including PyPy 3.  Users running `pip install --index-url 'https://:2022-09-25T15:39:59.680277Z@time-machines-pypi.sealsecurity.io/' h11` on
